...
if __name__ == "__main__":
    ...
    3. Укажи номер кассы в переменной `input_dir_name`.
    4. Создай директории приёмника и логов вручную.
    ...
    в явном виде в задании на кладке формат указваем файл обмена по маске *.txt
    и файл-флаг.
