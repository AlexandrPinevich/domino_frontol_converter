...
- Передача товара на кассы
    - Признак маркированного товара булевый, тег BMODE, требуется доработка Домино 
- Прием данных с касс
...
- [ ] Доработки
    ...
    - [ ] Доработать выгрузку из Домино, нужно получать тип маркированного товара
...
- [ ] Доработки 2й этап   
    ...
    - [X] Разобраться как грузить кассиров пакетом  
        ...
        - !!! ! пароли в явном виде, надо удалять обработанный файл загрузки
